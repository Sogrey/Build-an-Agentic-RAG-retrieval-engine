#!/usr/bin/env python3
"""
Simple PDF to Markdown converter without high-resolution OCR (avoids network download issues)
"""
...
def convert_pdf_to_markdown_simple(pdf_path, output_dir="pdf_images", output_md="output.md"):
    """
    Convert PDF to Markdown with extracted images (using basic strategy to avoid network issues)
...
if __name__ == "__main__":
    ...
    # Run conversion
    convert_pdf_to_markdown_simple(pdf_path, output_dir, output_md)